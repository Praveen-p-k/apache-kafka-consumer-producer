...
import { irysKafkaConsumerConfig } from './kafka/irys/irys.kafka-config';
import { fastPostKafkaConsumerConfig } from './kafka/fast-post/fast-post.kafka-config';
...
async function bootstrap() {
  ...
  app.connectMicroservice<MicroserviceOptions>(irysKafkaConsumerConfig());
  app.connectMicroservice<MicroserviceOptions>(fastPostKafkaConsumerConfig());
